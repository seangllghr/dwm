...
static char *fonts[]          = { "JetBrains Mono:size=12", "Font Awesome:pixelsize=16:antialias=true:autohint=true"  };
...
const char *spcmd2[] = {TERMINAL, "-n", "spcalc", "-f", "JetBrains Mono:size=14", "-g", "50x20", "-e", "bc", "-lq", NULL };
...
static const Layout layouts[] = {
	...
	{ "===",	bstackhoriz },  /* Master on top, stack tiled horizontally on bottom */
...
static Key keys[] = {
	...
	{ MODKEY|Mod1Mask,	XK_t,		setlayout,	{.v = &layouts[2]} }, /* bstackhoriz */
	...
	{ MODKEY,			XK_i,		setlayout,	{.v = &layouts[7]} }, /* centeredmaster */
	...
	{ MODKEY|Mod1Mask,	XK_space,	spawn,		SHCMD("emacs") },
